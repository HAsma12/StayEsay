<%@ Page Title="" Language="C#" MasterPageFile="~/View/Administrateur/administrateurMaster.Master" AutoEventWireup="true" CodeBehind="restaurantsrefuser.aspx.cs" Inherits="StayEsay.View.Administrateur.restaurantsrefuser" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <% 
                        ...
                        string sql = "SELECT Idrestaurant, nom , image_restau FROM restaurant  WHERE statu = 'Refuser'  ";
