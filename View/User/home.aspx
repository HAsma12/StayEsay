<%@ Page Title="" Language="C#" MasterPageFile="~/View/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="StayEsay.View.User.home" %>
    ...
    <section class="accomodation_area section_gap">
        <div class="container">
            <div class="section_title text-center">
                ...
                <%--<p>Nous vivons tous à une époque qui appartient aux jeunes de cœur. Une vie qui devient extrêmement rapide, <p/>--%>
            </div>
            <br />
            <div class="row mb_30">
