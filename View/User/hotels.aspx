<%@ Page Title="" Language="C#" MasterPageFile="~/View/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="hotels.aspx.cs" Inherits="StayEsay.View.User.hotels" %>
                        ...
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <p class="h3 text-decoration-none"><%= nom %></p>
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-secondary btn-sm" href="details_hotel1.aspx?Idhotel=<%= reader.GetInt32(0).ToString() %>" style="background-color:#ecabb5">Details</a></li>
