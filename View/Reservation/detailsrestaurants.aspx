<%@ Page Title="" Language="C#" MasterPageFile="~/View/Reservation/ReservationMaster.Master" AutoEventWireup="true" CodeBehind="detailsrestaurants.aspx.cs" Inherits="StayEsay.View.Reservation.detailsrestaurants" %>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <%--  <a href="reservertable.aspx">Réserver maintenant</a>--%>

                                <a class="btn btn-light" href="reservertable.aspx?Idrestaurant=<%= reader.GetInt32(reader.GetOrdinal("Idrestaurant")).ToString() %>" style="background-color: #cfabec">Réserver maintenant</a>
