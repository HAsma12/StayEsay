<%@ Page Title="" Language="C#" MasterPageFile="~/View/Reservation/ReservationMaster.Master" AutoEventWireup="true" CodeBehind="restaurants.aspx.cs" Inherits="StayEsay.View.Reservation.restaurants" EnableEventValidation="false" %>
                        ...
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                               ...
                               <%-- <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white mt-2" href="detailsrestaurants.aspx?Idrestaurant=<%= reader.GetInt32(0).ToString() %>">details</a></li>
                            ...
                            <div class="card-body">
                                <p class="h3 text-decoration-none"><%= nom %></p>
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-secondary btn-sm" href="detailsrestaurants.aspx?Idrestaurant=<%= reader.GetInt32(0).ToString() %>" style="background-color:#ecabb5">Details</a></li>
